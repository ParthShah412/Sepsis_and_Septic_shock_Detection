# -*- coding: utf-8 -*-
"""
Created on Mon Oct  7 14:25:14 2019
...
def get_per_hour_urine_output(cursor, i):
    query = '''
    select
          -- patient identifiers
        ...
        and oe.charttime between (ie.intime + interval '%d' hour) and (ie.intime + interval '%d' + 1 hour) -- first ICU hour
        where itemid in
        (
